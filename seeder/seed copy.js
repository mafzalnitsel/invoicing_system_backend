...
const collections = [
  ...
  },
  {
    name: "ContactPerson",
    model: ContactPerson,
    endpoint: "/BusinessPartnerss?$select=ContactEmployees&$top=3",
    keyField: "InternalCode", // adjust based on your schema
  },
  {
    name: "Branch",
    model: Branch,
    endpoint: "/BusinessPlaces?$top=3",
    keyField: "BPLID",
  },
  {
    name: "SalesEmployee",
    model: SalesEmployee,
    endpoint: "/SalesPersons?$top=3",
    keyField: "SalesEmployeeCode",
  },
  {
    name: "Owner",
    model: Owner,
    endpoint: "/EmployeesInfo?$top=3",
    keyField: "EmployeeID",
  },
  {
    name: "Item",
  ...
  },
  {
    name: "Tax",
    model: Tax,
    endpoint: "/VatGroups?$top=3",
    keyField: "Code",
  },
  {
    name: "Warehouse",
    model: Warehouse,
    endpoint: "/Warehouses?$top=3",
    keyField: "WarehouseCode",
  },
  {
    name: "CostCentre",
    model: CostCentre,
    endpoint: "/ProfitCenters?$top=3",
    keyField: "CenterCode",
  },
  {
    name: "ChartOfAccount",
    model: ChartOfAccount,
    endpoint: "/ChartOfAccounts?$top=3",
    keyField: "Code",
  },
  // {
  //   name: "Invoice",
